...
function SectionNote() {
  return (
    <section className="child-section" id="note-section">
       ...
       <img className="note-img" id="img-2" src={require("../../../images/ma2020/notes/2.png")} alt="img_2"/>
            <div id="box">
               ...
               <img className="note-img" id="img-1" src={require("../../../images/ma2020/notes/1.png")} alt="img_1"/>
                ...
                của cuộc thi từ ngày <span  >17.04.2020</span> đến trước 
                ngày <span  >23:59</span> ngày <span >24.04.2020</span><span style={{color: '#FFCF00'}}> (đối với đăng kí dự thi) </span>
                và  <span>22.04.2020</span><span style={{color: '#FFCF00'}}> (đối với đăng kí ghép nhóm);</span>
                <br></br>
                <br></br>
                <br></br>
                (ii) Đề thi vòng thi 01 của <span style={{color: '#FFCF00'}}>MARKETING ARENA 2020</span> sẽ được công bố vào ngày <span  >17.04.2020</span> trên
                ...
                <span  > 26.04.2020</span>. Cách thức và hình thức nộp
